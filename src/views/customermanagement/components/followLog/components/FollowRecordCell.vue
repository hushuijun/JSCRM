<template>
  <div class="fl-c">
    <flexbox class="fl-h">
      ...
      <div class="fl-h-b">
        <div class="fl-h-name"><span class="user-tips"> 跟进人：</span>{{item.realname}}</div>
        <div class="fl-h-time"><span class="user-tips"> 跟进时间：</span>{{item.createTime}}</div>
      </div>
    ...
    <div class="fl-b">
      <div class="fl-b-content"><span class="user-tips">跟进描述：</span>{{item.content}}</div>
      <div class="follow"
           v-if="item.category || item.nextTime">
        <div v-if="item.category"
              class="follow-info"><span class="user-tips">跟进方式：</span>{{item.category}}</div>
        <div v-if="item.nextTime"
              class="follow-info"><span class="user-tips">下次跟进时间：</span>{{item.nextTime}}</div>
      </div>
      <flexbox class="fl-b-images"
               v-if="item.img && item.img.length > 0"
               wrap="wrap">
        <span class="user-tips">附件：</span>
